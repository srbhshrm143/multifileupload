...
// ************************************************************************
api.flash = function(type, message, userSettings){
  ...
  module.settings.container = document.querySelector('#flashes');
  // the html template to be used for notifications (dom node)
  module.settings.template = document.querySelector('#template-flash');
