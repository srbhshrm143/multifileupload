...
git archive HEAD --prefix=stripe/  --format=zip -o "tmp/$next_version.zip"
...
confirm "Please upload ZIP file located in tmp/$next_version.zip in Partner Portal  https://portal.apps.near-me.com/pos_modules/52"
