...
const form_att = document.getElementById('uppy_custom_media_upload');
const total_items =  form_att.getAttribute('data-s3-uppy-max-number-of-files');
const _photo__type = form_att.getAttribute('data-s3-uppy-photo-type');

console.log("Total Number of Items to be Selected - " +total_items);

// Obejct-Id for Image
const _obj_uuid = form_att.getAttribute('data-s3-uppy-object-uuid');
